...
export const UploadFilesIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      className={className}
      fill="none"
...
export const FolderArrowIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      className={className}
      fill="none"
